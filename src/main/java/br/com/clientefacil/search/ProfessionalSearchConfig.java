...
public final class ProfessionalSearchConfig {

    private ProfessionalSearchConfig() {
    }
    ...
    public static Specification<Professional> byFilters(List<FilterRequest> filters) {
